...
function milestoneExists(sessionId, milestonePercent) {
    try {
        ...
        console.log(`milestoneExists error: ${err.message}`);
        return false;
    }
}
...
function createMilestone(sessionId, milestonePercent) {
    try {
        ...
        console.log(`Milestone: Error creating milestone - ${err.message}`);
    }
}

/**
 * Process milestones for a session based on current progress
 * @param {string} sessionId - Session ID
 * @param {number} progress - Current progress percentage
 */
function processSessionMilestones(sessionId, progress) {
...
onRecordAfterUpdateSuccess((e) => {
    try {
        ...
        processSessionMilestones(sessionId, progress);
    } catch (err) {
        console.log(`Milestone hook error: ${err.message}`);
    }
...
onRecordAfterCreateSuccess((e) => {
    try {
        ...
        console.log(`Milestone hook error on create: ${err.message}`);
    }
